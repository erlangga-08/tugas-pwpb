...
class Jurusan extends Database
{
    ...
    {
        // 1. mysqli_query
        $sql = $this->mysqli->query("SELECT * FROM jurusan") or die($this->CekError());
    ...
    public function detail($id)
    {
        ...
        id_jurusan='" . $id . "'") or die($this->CekError());
    ...
    function update($id, $data)
    {
        ...
        " WHERE id_jurusan='" . $id . "'") or die($this->CekError());
        // 4. tutup koneksi
        $this->TutupKoneksi();
    }
    function hapus($id)
    {
        ...
        $this->mysqli->query("DELETE FROM jurusan WHERE id_jurusan='$id'");
        // 2. tutup koneksi
        $this->TutupKoneksi();
    }
    function simpan($data)
    {
        ...
        $sql_simpan = "INSERT INTO jurusan 
